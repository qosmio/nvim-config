...
M.polish_hl = {
  ...
  ["@comment"] =                         { fg = c16.base03 },
  -- ["@string"] =                       { fg = c.orange },
  ["@function"]  =                       { fg = c.nord_blue },
  ["@parameter"] =                       { fg = c.red },
...
M.diff = {
  GitConflictIncomingLabel =             { fg = "#002B2E", bg = "#FC5FA3", bold = true },
  GitConflictCurrentLabel =              { fg = c.black, bg = c.green, bold = true },
  GitConflictAncestorLabel =             { fg = c.black, bg = c.dark_purple, bold = true },
...
local statusline = {
  IndentBlankLineChar =                  { ctermfg = 237 },
  DiffText =                             { ctermbg = 23 },
  StText =                               { ctermbg = 234, ctermfg = 252 },
  St_CommandMode =                       { ctermbg = 232, bold = true, ctermfg = 154 },
  St_ConfirmMode =                       { ctermbg = 232, bold = true, ctermfg = 156 },
  St_InsertMode =                        { ctermbg = 232, bold = true, ctermfg = 171 },
  St_LspHints =                          { ctermbg = 234, bold = true, ctermfg = 171 },
  St_LspInfo =                           { ctermbg = 234, bold = true, ctermfg = 154 },
  St_LspProgress =                       { ctermbg = 234, ctermfg = 162 },
  St_LspStatus =                         { ctermbg = 234, ctermfg = 154 },
  St_NTerminalMode =                     { ctermbg = 232, bold = true, ctermfg = 11 },
  St_NormalMode =                        { ctermbg = 232, bold = true, ctermfg = 147 },
  St_ReplaceMode =                       { ctermbg = 232, bold = true, ctermfg = 208 },
  St_SelectMode =                        { ctermbg = 232, bold = true, ctermfg = 147 },
  St_TerminalMode =                      { ctermbg = 232, bold = true, ctermfg = 154 },
  St_VisualMode =                        { ctermbg = 232, bold = true, ctermfg = 45 },
  St_cwd =                               { ctermbg = 232, ctermfg = 162 },
  St_encode =                            { ctermbg = 234, ctermfg = 214 },
  St_ft =                                { ctermbg = 234, ctermfg = 147 },
  St_lspError =                          { ctermbg = 234, bold = true, ctermfg = 162 },
  St_lspWarning =                        { ctermbg = 234, bold = true, ctermfg = 11 },
  StatusLine =                           { ctermbg = 234, ctermfg = 252 },
}
-- stylua: ignore end

local highlight = require("highlights.utils").gui_syntax_to_cterm(syntax)
-- print(vim.inspect(highlight))
-- require("highlights.utils").nvim_set_hl(highlight)
for k, _ in pairs(highlight) do
  ...
  -- end
  -- -- return require("highlights.utils").nvim_set_hl(syntax)
