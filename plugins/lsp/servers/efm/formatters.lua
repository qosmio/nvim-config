...
F.black = {formatCommand = "black --quiet -", formatStdin   = true}
F.stylua = {formatCommand = "stylua -s -", formatStdin   = true}
...
F.prettier = {formatCommand = "prettier --stdin-filepath ${INPUT}", formatStdin   = true}
return F
