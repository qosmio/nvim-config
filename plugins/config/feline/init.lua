...
local u = require "custom.plugins.config.feline.util"
...
vim.api.nvim_create_autocmd({ "VimEnter", "SessionLoadPost", "ColorScheme" }, {
  -- group = group_name,
  pattern = { "*" },
  callback = function()
    require("custom.plugins.config.feline.colors").generate_user_config_highlights()
    -- require("feline").reset_highlights()
  end,
})
